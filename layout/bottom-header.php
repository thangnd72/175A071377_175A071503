                ...
                <nav id="nav" class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="showMenu">
                        <ul class="navbar-nav mx-auto main-nav">
                            ...
                            <li class="dropdown"><a href="#" title="">Giới thiệu</a>
                                <div class="nav-sub">
                                    <ul class="dropdown-nav">
                                        ...
                                        <li><a href="#" title="">Hợp tác liên kết</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="dropdown"><a href="#" title="Thông báo">Thông báo</a>
                                <div class="nav-sub">
                                    <ul class="dropdown-nav">
                                        <li><a href="" title="">Thông báo</a></li>
                                        <li><a href="" title="">Thông Báo đào tạo</a></li>
                        ...
                        <div class="form-nav">
                            <form method="" class="form-inline" action="">
                                <input class="form-control mr2 w-50 m-4" name="" type="search"
